...
This report describes the results of `msm` and `ELECT` calls of model B, version 2. 
...
```{r reconstruct-edu-from-dummies, echo=T, results='show', message=FALSE, eval=T}
```
