...
read_chunk("./reports/model-summaries/tables-from-models.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r print-table-2, echo=echoChunks, message=TRUE, results='asis'}
```
