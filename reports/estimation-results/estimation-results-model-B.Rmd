...
read_chunk("./manipulation/map/3-estimate-model-b.R") 
```
...
# Remove cases
```{r remove-invalid-cases, echo=echoChunks, results='show', message=FALSE}
```
...
# Age diagnostic
```{r describe-age-composition, echo=TRUE, results='show', message=FALSE, eval=T, out.width="900px", out.height="300px"}
```
...
## Fitting function
```{r define-estimation-function, echo=echoChunks, results='show', message=FALSE}
```

### Support functions
```{r define-support-functions, echo=echoChunks, results='show', message=FALSE}
```

## Model
```{r specify-model, echo=echoChunks, results='show', message=FALSE}
```

## msm options
```{r specify-msm-options, echo=echoChunks, results='show', message=FALSE}
```

```{r estimate-msm-models, echo=echoChunks, results='show', message=FALSE}
```

```{r assemble-msm-models, echo=echoChunks, results='show', message=FALSE}
```

## elect options
```{r specify-elect-options, echo=echoChunks, results='show', message=FALSE}
```

```{r compute-life-expectancies, echo=echoChunks, results='show', message=FALSE}
```
