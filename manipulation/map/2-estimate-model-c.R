...
# ---- declare-globals ---------------------------------------------------------
pathSaveFolder <- "./data/shared/derived/models/model-c/"
digits = 2
...
estimate_multistate("mC1", ds, Q_crude, E, qnames,cov_names = "age")
(Q_crude <- get_crude_Q(ds, Q, "age + male"))
estimate_multistate("mC2", ds, Q_crude, E, qnames,cov_names = "age + male")
(Q_crude <- get_crude_Q(ds, Q, "age + male + educat"))
estimate_multistate("mC3", ds, Q_crude, E, qnames,cov_names = "age + male + educat")
(Q_crude <- get_crude_Q(ds, Q, "age + male + edu"))
estimate_multistate("mC4", ds, Q_crude, E, qnames,cov_names = "age + male + edu")
